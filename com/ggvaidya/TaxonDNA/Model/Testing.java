...
public class Testing { 
	...
	public static void testSequence() {
		int old_method = DNASequence.getPairwiseDistanceMethod();
		int old_overlap = DNASequence.getMinOverlap();
		testTransScoring();
		DNASequence.setPairwiseDistanceMethod(old_method);
		DNASequence.setMinOverlap(old_overlap);
	}
