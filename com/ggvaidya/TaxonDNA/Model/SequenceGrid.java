...
public class SequenceGrid {
	 ...
	 * to null. 
	 */
	public static final String CANCELLED_PROPERTY =	"com.ggvaidya.TaxonDNA.DNA.SequenceGrid.cancelled";
	 ...
	 */
	public static final String INITIAL_COLNAME_PROPERTY = "com.ggvaidya.TaxonDNA.DNA.SequenceGrid.initialColName";
	 ...
	 */
	public static final String INITIAL_SEQNAME_PROPERTY = "com.ggvaidya.TaxonDNA.DNA.SequenceGrid.initialSeqName";
...
//
	 ...
	 * @return null, if either the column or sequence name does not exist (or the sequence name does not exist in this column)
	 */
	public DNASequence getSequenceIgnoreCancelled(String colName, String seqName) {
		validateColName(colName);
		validateSeqName(seqName);
	...
	public Set getSequenceNamesByColumn(String colName) {
		...
		while(i.hasNext()) {
			...
			if(getSequenceIgnoreCancelled(colName, seqName) != null)
				set.add(seqName);
		}
...
//
	...
	public String testRenameSequence(String seqOld, String seqNew) {
		...
		while(i_cols.hasNext()) {
			...
			DNASequence seq = getSequenceIgnoreCancelled(colName, seqOld);

			if(seq != null) {
				DNASequence replacing = getSequenceIgnoreCancelled(colName, seqNew);
	 ...
	 * methods. But that's for another day.
	 *
	...
	public void addColumnFromDataStore(com.ggvaidya.TaxonDNA.SequenceMatrix.DataStore ds, String colName, boolean includeNAs)  {
		...
		while(i.hasNext()) {
			String seqName = (String) i.next();
			DNASequence seq = ds.getCancelledSequence(colName, seqName);

			if(seq == null)
				seq = DNASequence.makeEmptySequence(seqName, ds.getColumnLength(colName));
