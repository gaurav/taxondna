...
public class SortedSequenceList {
	...
	private DNASequence 		query;		// the query used to generate the copy
...
//		
	 ...
	 */
	public void sortAgainst(DNASequence query, DelayCallback delay) throws DelayAbortedException {
		int count = 0;
		...
		while(listIterator.hasNext()) {
			count++;
			DNASequence seq = (DNASequence) listIterator.next();
...
//
	 ...
	 */
	public DNASequence get(int x) {
		if(x >= sorted.count())
			return null;
		return (DNASequence) sorted.get(x);
	}
...
class SortedSequenceComparator implements Comparator {
	 ...
	 */
	public SortedSequenceComparator(DNASequence seq) {
		this.query = seq;
	}	
	...
	public int compare(Object obj1, Object obj2) {
		...
		DNASequence seq1 = (DNASequence) obj1;	// a CastException is just as bad
		DNASequence seq2 = (DNASequence) obj2;	// as a RuntimeException
