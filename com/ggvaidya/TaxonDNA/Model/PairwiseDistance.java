...
public class PairwiseDistance implements Comparable {
	...
	private DNASequence seqA =		null;
	public DNASequence getSequenceA()	{	return seqA;	}
	private DNASequence seqB =		null;
	public DNASequence getSequenceB()	{	return seqB;	}

	public PairwiseDistance(DNASequence a, DNASequence b) {
		seqA = a;
		seqB = b;
	...
	public boolean isMentioned(DNASequence seq) {
