...
public class PhylipFile extends BaseFormatHandler {
	 ...
	 */
	public  String getShortName() {		return "Phylip";		}
	 ...
	 */
	public  String getFullName() {		return "Phylip format"; 	}
	 ...
	 */
	public void writePhylipFile(File file, SequenceList set, DelayCallback delay) throws IOException, DelayAbortedException {
		set.lock();
