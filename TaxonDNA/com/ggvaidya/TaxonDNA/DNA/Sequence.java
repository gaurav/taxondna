...
//
	...
	/**
	 * Shrink the species name (Genus species) to fit within
	...
	public void test(TestController test, DelayCallback delay) {
		...
		try {
			...
			if(	seq_trex.getSpeciesName(5).equals("T rex") &&
				seq_trex.getSpeciesName(9).equals("Tyran rex") &&
				seq_trex.getSpeciesName(50).equals("Tyrannosaurus rex")
			)
				test.succeeded();
			else
				test.failed("I shrink the name with getSpeciesName! e.g. \"Tyrannosaurus rex\".getSpeciesName(10) = '" + seq_trex.getSpeciesName(10) + "'");
		} catch(SequenceException e) {
