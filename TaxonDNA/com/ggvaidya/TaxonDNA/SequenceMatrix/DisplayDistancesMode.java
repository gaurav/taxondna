...
public class DisplayDistancesMode extends DisplayMode implements ActionListener { 
...
//
	...
	/**
	 * Event: somebody rightclicked in the mainTable somewhere
	 */
		/**
...
//		popupMenu.show((Component)e.getSource(), e.getX(), e.getY());
		...
		java.awt.MenuItem resizeCol = new java.awt.MenuItem("Resize column to fit");
		resizeCol.setActionCommand("RESIZE_COLUMN:" + colName);
		pm.add(resizeCol);

		if(col >= additionalColumns) {
			java.awt.MenuItem delThisCol = new java.awt.MenuItem("Delete column");
			delThisCol.setActionCommand("COLUMN_DELETE:" + colName);
			pm.add(delThisCol);

			java.awt.MenuItem pdmThisCol = new java.awt.MenuItem("Display pairwise distances");
		...
		if(row <= 0) {
			...
			java.awt.MenuItem delThisRow = new java.awt.MenuItem("Delete this row");
			delThisRow.setActionCommand("ROW_DELETE:" + rowName);
			pm.add(delThisRow);

			if(outgroupName != null && rowName.equals(outgroupName)) {
				java.awt.MenuItem makeOutgroup = new java.awt.MenuItem("Unset this row as the outgroup");
				makeOutgroup.setActionCommand("MAKE_OUTGROUP:");
				pm.add(makeOutgroup);		
			} else {
				java.awt.MenuItem makeOutgroup = new java.awt.MenuItem("Make this row the outgroup");
