...
public class SequenceEdit extends Panel
  ...
  /**
   * Returns the Sequence() indicated. Note that you are entirely responsible for ensuring that the
   * seqId list stays in sync. Maybe a method in seqId?
   */
  ...
  /**
   * Updates name related information. (i.e. based on the full name, it sets family, species, gi and
   * the like.
   */
  ...
  public void actionPerformed(ActionEvent evt) {
    ...
    if (cmd.equals("Copy to Clipboard") || cmd.equals("Oops, try again?")) {
      ...
      if (gi_number != null
        ...
        String url =
            new String("http://www.ncbi.nlm.nih.gov/entrez/viewer.fcgi?db=nucleotide&val=" + gi);
        try {
          ...
          MessageBox mb =
              new MessageBox(
                  ...
                  "This program couldn't open your web browser to access NCBI. You can access this entry at "
                      + url);
          mb.go();
        }
      }
  ...
  // Key listener
  /**
   * We save the text in the 'name' and 'sequence' field when we gain focus. Then, when we loose it,
   * we can check to see if anything changed.
   */
  ...
  public void focusGained(FocusEvent e) {
    ...
    if (e.getSource().equals(text_sequence)) focusGained_sequence = text_sequence.getText().trim();
  }
