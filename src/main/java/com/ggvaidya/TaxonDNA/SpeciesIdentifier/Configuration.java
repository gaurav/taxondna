...
public class Configuration extends Panel implements UIExtension, ActionListener, FocusListener {
    ...
    Label warningLabel =
            new Label(
                    "Please wait, loading SpeciesIdentifier ..."); // warning: please set up BEFORE
    // loading
    // files
    ...
    public Configuration(SpeciesIdentifier seqId) {
        ...
        */
        ...
        rl.add(
                new Label("Calculate pairwise distances as"),
        ...
        rl.add(
                new Label(
                        "Note that differences in leading and trailing gaps are ignored, while"
                                + " differences in internal gaps will be counted."),
    ...
    public void unlock() {
        ...
        warningLabel.setText(
                "Please change your settings BEFORE loading a file into this program.");
    ...
    public void dataChanged() {
        ...
        if (list == null) {
            ...
            warningLabel.setText(
                    "There is a file loaded into this program. You cannot change these settings"
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(lock_button)) {
            if (locked) unlock();
                ...
                lock();
                warningLabel.setText(
                        "You have locked these settings. Please click on the \"Unlock\" button to"
                                + " unlock it.");
                lock_button.setLabel("Unlock Settings");
            }
        }
    ...
    public void loadFromPrefs() {
        Preferences prefs =
                Preferences.userNodeForPackage(
                        com.ggvaidya.TaxonDNA.SpeciesIdentifier.Configuration.class);
    ...
    private void lockDown(boolean state) {
        if (state) { // lock down!
            ...
            warningLabel.setText(
                    "You cannot modify the Configuration if more than one SpeciesIdentifier windows"
                        + " are open. Please close all but one window if you need to change these"
                        + " settings.");
            lock_button.setEnabled(false);
        } else { // unlock down!
            unlock();
     ...
     * multiple times. It's also a static method: it will unlock or lockup EVERY SINGLE
     * Configuration in existance.
     *
     * <p>Pretty cool, eh?
     */
