            ...
            if (seqId.getExtension("Pairwise Summary") != null) {
                ...
                if (pd_intra == null || pd_inter == null) {
                    ...
                    double prob_intra =
                            100
                                    - percentage(
                                            pd_intra.getBetween(0, pairwise),
                                            pd_intra.countValidComparisons());
                    double prob_inter =
                            percentage(
                                    pd_inter.getBetween(0, pairwise),
                                    pd_inter.countValidComparisons());
                    ...
                    if (pd_inter.countValidComparisons() > 0)
                        str.append(
                                prob_inter
                                        + "% of intrageneric but interspecific distances are"
                                        + " smaller than "
                                        + str_pairwise
                                        + "%.\n");
                }
                ...
                str.append(
                        "The pairwise distribution module (PairwiseSummary) has not been loaded"
                                + " into this program. I need that program to calculate pairwise"
                                + " distances.\n\n"
