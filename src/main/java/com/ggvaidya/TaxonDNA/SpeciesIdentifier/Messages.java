...
public class Messages {
    ...
    private static String[] errorMessages = {
        ...
        "The file '$1$' could not be read. Please check whether the file exists, and that you have"
                + " sufficient permissions to read this file.",
        // SAVE_FILE_FORMAT
        "Saving file '$1$' in the $2$ format. To save export this file to another format, you may"
                + " use the 'Export' menu.",
        // READING_FILE:
        "Reading sequences from '$1$' into SpeciesIdentifier. This might take some time.",
        // IOEXCEPTION_READING:		file, exception
        "There was an error while reading from '$1$'. Please ensure that the file exists, that you"
            + " have permission to read it, and that there are no problems with the drive on which"
            + " the file is being read from.\n\n"
            + "The technical description of this error is: $2$",
        // IOEXCEPTION_WRITING:		file, exception
        "There was an error while writing to '$1$'. Please ensure that you have permission to"
            + " create or modify this file, that the drive on which the file is being written is"
            + " not full or set 'write-only'.\n\n"
            + "The technical description of this error is: $2$",
        // IOEXCEPTION_WRITING_NO_FILENAME:	exception
        "There was an error while trying to write a file. Please ensure that the drive on which the"
                + " file is being written is not full or set 'write-only'.\n\n"
                + "The technical description of this error is: $1$",
        // COPY_TO_CLIPBOARD_FAILED:	exception
        "There was an error copying to the clipboard. The text was probably not copied. Please try"
                + " again; if this doesn't work, please report it as a bug.\n\n"
                + "Technical explanation: $1$",
        // NEED_SPECIES_SUMMARY
        "To carry out this operation, I need the Species Summary module, which was not built into"
            + " your SpeciesIdentifier. You can try downloading the most recent one, or download"
            + " the \"definitive\" copy from http://taxondna.sf.net/"
    };
    ...
    public static String getMessage(int code) {
        ...
        return "An illegal error code occured (error code "
                + code
                + "). This is a programming error. Please contact the developer(s) at"
