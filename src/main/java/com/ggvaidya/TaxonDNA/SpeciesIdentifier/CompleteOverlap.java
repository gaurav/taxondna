...
public class CompleteOverlap extends Panel implements UIExtension, Runnable, ActionListener {
  ...
  private String getOverlapDisplay(SequenceList sl, int from, int to, DelayCallback delay) {
    ...
    while (i.hasNext()) {
      ...
      try {
        ...
        MessageBox mb =
            new MessageBox(seqId.getFrame(), "Unable to extract subsequence", e.toString());
        mb.go();
  ...
  public void actionPerformed(ActionEvent evt) {
    ...
    if (evt.getSource().equals(btn_Export_Results)) {
      ...
      FileDialog fd =
          new FileDialog(
              seqId.getFrame(), "Where would you like me to save the results to?", FileDialog.SAVE);
      ...
      try {
        ...
        else pw.println("from,to,sequences,sequences_defined,species,non_singleton_species");
