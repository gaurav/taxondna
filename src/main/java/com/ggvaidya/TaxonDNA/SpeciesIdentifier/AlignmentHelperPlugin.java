...
public class AlignmentHelperPlugin extends Panel implements UIExtension, ActionListener {
  ...
  public AlignmentHelperPlugin(SpeciesIdentifier view) {
    ...
    finp_Input =
        new FileInputPanel("Clustal input: ", FileInputPanel.MODE_FILE_WRITE, view.getFrame());
    ...
    finp_Output =
        new FileInputPanel("Clustal output: ", FileInputPanel.MODE_FILE_READ, view.getFrame());
      ...
      if (id == null || id.equals("")) {
        ...
        if (!warned) {
          mb =
              new MessageBox(
                  ...
                  "Some of the sequences in this dataset do not have GI numbers. To create Clustal input files, I'm going to have to allocate unique identifiers to these sequences. Doing so will not cause problems with this dataset, but it WILL rewrite the original file. THE CURRENT FILE WILL BE OVERWRITTEN, AND ANY CHANGES YOU'VE MADE WILL BE SAVED PERMANENTLY TO DISK. Are you sure you want to do this?",
                  MessageBox.MB_YESNO);
          if (mb.showMessageBox() == MessageBox.MB_YES) {
            ...
            mb =
                new MessageBox(
                    ...
                    "I can't export files for Clustal without assigning unique identifiers to each sequence. Please re-run if you would like to export files for Clustal.");
            mb.go();
        ...
        mb =
            new MessageBox(
                ...
                "Two sequences in this dataset have identical GI numbers. I can't use this for a mapfile. Please delete one of the duplicate pair of sequences. The duplicate pair which caused this error was:\n\t"
                    + seq.getFullName()
                    + "\nand\nGI:\t"
                    + id);
        mb.go();
