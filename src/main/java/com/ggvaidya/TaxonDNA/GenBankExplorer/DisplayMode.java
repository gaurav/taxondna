...
public abstract class DisplayMode implements TreeModel, TreeSelectionListener {
  ...
  /**
   * Fires a tree event at all listening TreeModelListeners. Warning: this will ONLY fire the event
   * as a treeStructureChanged(TreeModelEvent). If you need a less powerful event to be fired, err
   * ... update this code?
   */
