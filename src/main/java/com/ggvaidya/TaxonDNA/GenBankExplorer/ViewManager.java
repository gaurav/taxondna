...
public class ViewManager implements MouseListener {
  ...
  public void createUI() {
    ...
    JSplitPane p_textareas =
        new JSplitPane(
            JSplitPane.VERTICAL_SPLIT, new JScrollPane(ta_file), new JScrollPane(ta_selected));
  ...
  public void loadFile(File f) {
    ...
    try {
      ...
      displayException(
          ...
          "The file '"
              + f
              + "' could be read as a GenBank file. Are you sure it is a properly formatted GenBank file?\nThe following error occured while trying to read this file: "
              + e.getMessage());
      return;
