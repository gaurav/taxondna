...
public class MessageBox extends Dialog implements ActionListener {
  ...
  /**
   * Specify that the message is unique to the entire program, and can be used to uniquely identify
   * this particular message.
   */
    ...
    if ((flags & MB_YESNOTOALL) != 0) {
      if (((flags & MB_TITLE_IS_UNIQUE) == 0) && ((flags & MB_MESSAGE_IS_UNIQUE) == 0)) {
        throw new IllegalArgumentException(
            "MessageBox creation attempted with MB_YESNOTOALL set, but without either MB_TITLE_IS_UNIQUE or MB_MESSAGE_IS_UNIQUE set!");
      }
    }
  }
  ...
  /**
   * A static 'constructor', if all you've got is a Window, without a flags field. We'll figure out
