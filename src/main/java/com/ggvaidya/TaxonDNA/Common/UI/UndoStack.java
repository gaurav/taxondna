/**
 * An UndoStack encapsulated a Stack which keeps a list of 'tasks' executed.
 * Tasks are defined by UI.UndoTask.
 *
 * One important thing which UndoStack needs to be capable of doing is to be
 * as memory efficient as possible. It's likely that once an object is
 * deleted, we will be the only people to refer to it; thus, it is our
 * responsibility to free it as soon as is feasible.
 */
