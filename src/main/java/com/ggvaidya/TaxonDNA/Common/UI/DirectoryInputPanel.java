...
public class DirectoryInputPanel extends Panel implements ActionListener, TextListener {
            ...
            if (f.exists()) {
                ...
                if (fileLoadedThroughDialog) {
                    ...
                    if (mb.showMessageBox() != MessageBox.MB_YES) {
                        f =
                                getFileFromFileDialog(
                                        "Please choose another directory to use instead ...");
    ...
    /**
     * Listens for changes to the textfield. This way, we KNOW if somebody modified the field
     * outside of the browse dialog.
     */
