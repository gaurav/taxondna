/**
 * A Testable class is one which can be tested. That wasn't too hard. To specify in additional
 * detail, all Testable objects have a function called 'test()', which runs a series of tests. The
 * results are signalled back to the caller via a callback mechanism (see Common.TestController).
 *
