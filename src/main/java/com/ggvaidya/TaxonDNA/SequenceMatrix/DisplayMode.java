...
public abstract class DisplayMode implements TableModel, MouseListener {
    ...
    /**
     * Note that this function will return the *absolute* index (it must, it IS in the interface).
     * So do remember that when you use this function, alright children?
     */
    ...
    /**
     * Saves the column widths into a Hashtable. You can use restoreWidths() to restore your widths
     * to where they were a while ago.
     */
     ...
     * TableModels being set repeatedly, it makes sense to check that we're not double adding a
     * single listener.
     */
    ...
    /**
     * Update the display (generally by firing an event at all the tableModelListeners). Feel free
     * to overload this if you think you've got a better idea - but PLEASE remember to save and
     * reload the table headers before you do!
     */
