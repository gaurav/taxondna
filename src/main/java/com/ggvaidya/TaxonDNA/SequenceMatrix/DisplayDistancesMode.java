...
public class DisplayDistancesMode extends DisplayMode implements ItemListener {
        ...
        public int compareTo(Object o) {
            ...
            if (!s.getSeqNameTop().equals(getSeqNameTop()))
                throw new RuntimeException(
                        "Two sequences without identical reference sequences being compared in"
                                + " DisplayDistancesMode.Score!");
    ...
    /**
     * We, err, use our mode-specific menu to flip between pairwise distance types. That makes
     * sense, no? No?
     */
