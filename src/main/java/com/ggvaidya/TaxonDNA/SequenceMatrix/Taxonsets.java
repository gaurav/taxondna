...
public class Taxonsets implements WindowListener, ItemListener, ActionListener {
    ...
    private Checkbox check_generateGeneSets =
            new Checkbox(
                    "Generate taxonsets for all taxa having information for a particular gene");
    ...
    public Taxonsets(SequenceMatrix matrix) {
        ...
        rl.add(
                ...
                RightLayout.NEXTLINE
                        | RightLayout.STRETCH_X
                        | RightLayout.STRETCH_Y
                        | RightLayout.FILL_3);
                ...
                MessageBox mb =
                        new MessageBox(
                                ...
                                "You specify that the new taxonset should have '"
                                        ...
                                        + ", but '"
                                        + newValue
                                        + "' isn't a valid number! Please lets use a number I can"
                                        + " understand, thanks.",
                                MessageBox.MB_OK);
    ...
    /**
     * Returns a Vector of all the taxonSets we have (as String). You can then query this list
     * against Exporter.getTaxonset(String) to get the Taxonset in question (as a single line, etc.)
     */
