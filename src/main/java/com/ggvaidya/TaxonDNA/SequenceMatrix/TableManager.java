...
public class TableManager implements ActionListener {
   ...
   * columns, not shrink them. This method can therefore be called with minimum user disturbance (I
   * think).
   */
  ...
  public void deleteColumn(String colName) {
    if (warned(
        "Delete this column?", "Are you sure you wish to delete column '" + colName + "'?")) {
  ...
  public void deleteRow(String taxonName) {
    if (warned(
        "Delete this taxon?", "Are you sure you wish to delete the taxon '" + taxonName + "'?")) {
      ...
      MessageBox mb =
          new MessageBox(
              ...
              "Renaming '"
                  ...
                  + "' to '"
                  + newName
                  + "' will cause the following problems. Are you sure you want to go ahead with this rename?\n"
                  + complaints,
              MessageBox.MB_YESNO);
  ...
  public void updateStatusBar() {
    ...
    if (toolbarManager.getCurrentSequence() != null) {
      buff.append(
          toolbarManager.getCurrentColumn() + ": " + toolbarManager.getCurrentSequence() + ". ");
    }
