/**
 * Commands have commands to access SequenceMatrix functionality through commands. For now, this is
 * entirely for the command line command system, but maybe an Undo/Redo system could be built up
 * about this.
 */
